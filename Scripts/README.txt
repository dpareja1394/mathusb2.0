...
Los archivos permisos_mathusb_user.sql y permisos_secuencias_mathusb_user.sql son para dar permisos al usuario mathusb_user sobre las tablas 
y las secuencias de la base de datos solo si los scripts no se han ejecutado con este usuario conectado.