...
public class TipoEvaluacionLogic implements ITipoEvaluacionLogic {
    ...
    */
    ...
    public void saveTipoEvaluacion(TipoEvaluacion entity)
        ...
        try {
            if (entity.getDescripcionTipoEvaluacion() == null) {
            ...
            if ((entity.getDescripcionTipoEvaluacion() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getDescripcionTipoEvaluacion(), 2500) == false)) {
            ...
            if (entity.getTievId() == null) {
                throw new ZMessManager().new EmptyFieldException("tievId");
            }

            if (getTipoEvaluacion(entity.getTievId()) != null) {
    ...
    public void deleteTipoEvaluacion(TipoEvaluacion entity)
        ...
        try {
            evaluacions = evaluacionDAO.findByProperty("tipoEvaluacion.tievId",
                    entity.getTievId());
            ...
            tipoEvaluacionDAO.delete(entity);
    ...
    public void updateTipoEvaluacion(TipoEvaluacion entity)
        ...
        try {
            ...
            log.error("update TipoEvaluacion failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public List<TipoEvaluacionDTO> getDataTipoEvaluacion()
        ...
        try {
            ...
            for (TipoEvaluacion tipoEvaluacionTmp : tipoEvaluacion) {
                ...
                tipoEvaluacionDTO2.setTievId(tipoEvaluacionTmp.getTievId());
                tipoEvaluacionDTO2.setDescripcionTipoEvaluacion((tipoEvaluacionTmp.getDescripcionTipoEvaluacion() != null)
                    ? tipoEvaluacionTmp.getDescripcionTipoEvaluacion() : null);
                tipoEvaluacionDTO2.setNombreCorto((tipoEvaluacionTmp.getNombreCorto() != null)
                    ? tipoEvaluacionTmp.getNombreCorto() : null);
    ...
    public TipoEvaluacion getTipoEvaluacion(Long tievId)
        ...
        try {
            entity = tipoEvaluacionDAO.findById(tievId);
        } catch (Exception e) {
