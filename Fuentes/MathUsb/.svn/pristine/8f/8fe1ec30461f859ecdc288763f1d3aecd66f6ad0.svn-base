...
public class RespuestaLogic implements IRespuestaLogic {
    ...
    */
        ...
        try {
            ...
            if ((entity.getDescripcionRespuesta() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getDescripcionRespuesta(), 2500) == false)) {
    ...
    public void deleteRespuesta(Respuesta entity) throws Exception {
        ...
        try {
            evaPregReses = evaPregResDAO.findByProperty("respuesta.respId",
                    entity.getRespId());
    ...
    public List<RespuestaDTO> getDataRespuesta() throws Exception {
        try {
            ...
            for (Respuesta respuestaTmp : respuesta) {
                ...
                respuestaDTO2.setRespId(respuestaTmp.getRespId());
                respuestaDTO2.setDescripcionRespuesta((respuestaTmp.getDescripcionRespuesta() != null)
                    ? respuestaTmp.getDescripcionRespuesta() : null);
    ...
    public Respuesta getRespuesta(Long respId) throws Exception {
        ...
        try {
            entity = respuestaDAO.findById(respId);
        } catch (Exception e) {
