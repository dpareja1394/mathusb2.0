...
public class EvaluacionDAO extends HibernateDaoImpl<Evaluacion, Long>
	...
	public List<Evaluacion> obtenerEvaluacionesDelGrupoDisponiblesEnFechaHoy(Long idGrupo) throws  Exception{
		...
		if(idGrupo == null){
			throw new Exception("Porfavor especifique un grupo.");
		}

    	List<Evaluacion> listDto = null;

    	try {
    		
    		Query query = getSession().getNamedQuery("obtenerEvaluacionesDelGrupoDisponiblesEnFechaHoy");
    		
    		query.setParameter("pGrupoId", idGrupo);
