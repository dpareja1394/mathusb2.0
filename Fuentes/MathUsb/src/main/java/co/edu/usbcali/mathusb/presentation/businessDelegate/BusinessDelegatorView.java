...
public class BusinessDelegatorView implements IBusinessDelegatorView {
	...
	public List<Asignatura> findByCriteriaInAsignatura(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return asignaturaLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Asignatura> findPageAsignatura(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return asignaturaLogic.findPageAsignatura(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<Comentario> findByCriteriaInComentario(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return comentarioLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Comentario> findPageComentario(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return comentarioLogic.findPageComentario(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<DetalleEvaluacion> findByCriteriaInDetalleEvaluacion(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return detalleEvaluacionLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<DetalleEvaluacion> findPageDetalleEvaluacion(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return detalleEvaluacionLogic.findPageDetalleEvaluacion(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<EvaPregRes> findByCriteriaInEvaPregRes(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return evaPregResLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<EvaPregRes> findPageEvaPregRes(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return evaPregResLogic.findPageEvaPregRes(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<Grupo> findByCriteriaInGrupo(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return grupoLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Grupo> findPageGrupo(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
		return grupoLogic.findPageGrupo(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<GrupoUsuario> findByCriteriaInGrupoUsuario(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return grupoUsuarioLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<GrupoUsuario> findPageGrupoUsuario(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return grupoUsuarioLogic.findPageGrupoUsuario(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<Herramienta> findByCriteriaInHerramienta(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return herramientaLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Herramienta> findPageHerramienta(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return herramientaLogic.findPageHerramienta(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<Parametro> findByCriteriaInParametro(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return parametroLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Parametro> findPageParametro(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
		return parametroLogic.findPageParametro(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<Tema> findByCriteriaInTema(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return temaLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Tema> findPageTema(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
		return temaLogic.findPageTema(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public TipoEvaluacion getTipoEvaluacion(Long tievId) throws Exception {
	...
	public void saveTipoHerramienta(TipoHerramienta entity) throws Exception {
		tipoHerramientaLogic.saveTipoHerramienta(entity);
	}

	public void deleteTipoHerramienta(TipoHerramienta entity) throws Exception {
		tipoHerramientaLogic.deleteTipoHerramienta(entity);
	}

	public void updateTipoHerramienta(TipoHerramienta entity) throws Exception {
		tipoHerramientaLogic.updateTipoHerramienta(entity);
	}

	public TipoHerramienta getTipoHerramienta(Long tiheId) throws Exception {
	...
	public List<TipoHerramienta> findByCriteriaInTipoHerramienta(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return tipoHerramientaLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<TipoHerramienta> findPageTipoHerramienta(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return tipoHerramientaLogic.findPageTipoHerramienta(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<TipoHerramientaDTO> getDataTipoHerramienta() throws Exception {
	...
	public List<Usuario> findByCriteriaInUsuario(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return usuarioLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<Usuario> findPageUsuario(String sortColumnName, boolean sortAscending, int startRow, int maxResults)
			throws Exception {
		return usuarioLogic.findPageUsuario(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<UsuarioEvaluacion> getUsuarioEvaluacion() throws Exception {
		return usuarioEvaluacionLogic.getUsuarioEvaluacion();
	}

	public void saveUsuarioEvaluacion(UsuarioEvaluacion entity) throws Exception {
		usuarioEvaluacionLogic.saveUsuarioEvaluacion(entity);
	}

	public void deleteUsuarioEvaluacion(UsuarioEvaluacion entity) throws Exception {
		usuarioEvaluacionLogic.deleteUsuarioEvaluacion(entity);
	}

	public void updateUsuarioEvaluacion(UsuarioEvaluacion entity) throws Exception {
		usuarioEvaluacionLogic.updateUsuarioEvaluacion(entity);
	}

	public UsuarioEvaluacion getUsuarioEvaluacion(Long usevId) throws Exception {
	...
	public List<UsuarioEvaluacion> findByCriteriaInUsuarioEvaluacion(Object[] variables, Object[] variablesBetween,
			Object[] variablesBetweenDates) throws Exception {
		return usuarioEvaluacionLogic.findByCriteria(variables, variablesBetween, variablesBetweenDates);
	}

	public List<UsuarioEvaluacion> findPageUsuarioEvaluacion(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		return usuarioEvaluacionLogic.findPageUsuarioEvaluacion(sortColumnName, sortAscending, startRow, maxResults);
	}
	...
	public List<UsuarioEvaluacionDTO> getDataUsuarioEvaluacion() throws Exception {
	...
	@Override
	public ByteArrayInputStream generarReporteEvaluacion(REPORT_OUTPUT_TYPE reportOutputTye, Long eval_Id)
			throws Exception {
