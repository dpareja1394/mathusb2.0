...
public class FacesUtils {
 ...
 public static Double checkDouble(Object input) throws ZMessManager {
	...
	public static void update(String idComponenteToUpdate){
		RequestContext requestContext = RequestContext.getCurrentInstance();  
		requestContext.update(idComponenteToUpdate);
	}
	
	public static Integer getEmpresaIntoSession(){
		return (Integer) getfromSession(SessionVariables.STRING_EMPRESA_SESSION);
	}
	
	public static Integer getUsuarioIntoSession(){
		return (Integer) getfromSession(SessionVariables.STRING_USUARIO);
	}
