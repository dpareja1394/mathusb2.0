 ...
 */
@Scope("singleton")
@Repository("TipoEvaluacionDAO")
public class TipoEvaluacionDAO extends HibernateDaoImpl<TipoEvaluacion, Long>
    implements ITipoEvaluacionDAO {
    private static final Logger log = LoggerFactory.getLogger(TipoEvaluacionDAO.class);
    @Resource
    private SessionFactory sessionFactory;

    public static ITipoEvaluacionDAO getFromApplicationContext(
        ApplicationContext ctx) {
        return (ITipoEvaluacionDAO) ctx.getBean("TipoEvaluacionDAO");
    }
}
