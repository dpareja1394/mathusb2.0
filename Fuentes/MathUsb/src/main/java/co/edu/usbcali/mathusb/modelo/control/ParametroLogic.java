...
public class ParametroLogic implements IParametroLogic {
    ...
    public void saveParametro(Parametro entity) throws Exception {
        ...
        try {
            if ((entity.getDescripcionParametros() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getDescripcionParametros(), 2500) == false)) {
            ...
            if (entity.getParamId() == null) {
                throw new ZMessManager().new EmptyFieldException("paramId");
            }
            ...
            if (getParametro(entity.getParamId()) != null) {
    ...
    public List<ParametroDTO> getDataParametro() throws Exception {
        try {
            ...
            for (Parametro parametroTmp : parametro) {
                ...
                parametroDTO2.setParamId(parametroTmp.getParamId());
                parametroDTO2.setDescripcionParametros((parametroTmp.getDescripcionParametros() != null)
                    ? parametroTmp.getDescripcionParametros() : null);
                parametroDTO2.setEstadoRegistro((parametroTmp.getEstadoRegistro() != null)
                    ? parametroTmp.getEstadoRegistro() : null);
    ...
    public Parametro getParametro(Long paramId) throws Exception {
        ...
        try {
            entity = parametroDAO.findById(paramId);
        } catch (Exception e) {
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public Parametro getParametroPorDescripcion(String descripcion) throws Exception {
        log.info(".:: Buscando el parametro : "+ descripcion +" en la base de datos. ::.");

        Parametro entity = null;

        try {
            entity = findByCriteria(new Object[]{"descripcionParametros",true,descripcion,"="}, null, null).get(0);
            
            log.info(".:: Parametro : "+ descripcion +" encontrado en la base de datos con el id "+entity.getParamId()+" ::.");
        } catch (Exception e) {
            log.error(".:: Busqueda del parametro "+descripcion+" falló ::.", e);
            throw new ZMessManager("No existe el parametro : "+descripcion+" en la base de datos.");
        } finally {
        }
