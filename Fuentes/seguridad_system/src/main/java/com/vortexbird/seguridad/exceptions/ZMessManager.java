package com.vortexbird.seguridad.exceptions;
...
public class ZMessManager extends Exception {
    ...
    public static String ENTITY_SUCCESFULLYSAVED = "Se ha guardado satisfactoriamente.";
    public static String ENTITY_SUCCESFULLYDELETED = "Se ha eliminado satisfactoriamente";
    public static String ENTITY_SUCCESFULLYMODIFIED = "Se ha modificado satisfactoriamente.";
