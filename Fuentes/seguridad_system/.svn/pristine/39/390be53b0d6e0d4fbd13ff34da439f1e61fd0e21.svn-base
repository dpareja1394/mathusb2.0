package com.vortexbird.seguridad.dataaccess.entityManager;
...
public class EntityManagerHelper {
    ...
    static {
        emf = Persistence.createEntityManagerFactory("sis_seguridadPU");
        threadLocal = new ThreadLocal<EntityManager>();
        logger = Logger.getLogger("sis_seguridadPU");
