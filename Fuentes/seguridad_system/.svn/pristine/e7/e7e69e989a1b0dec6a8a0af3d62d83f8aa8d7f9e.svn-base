						...
						if (menus!=null && menus.size()>0) {
							...
							for (int i = 0; i < menus.size(); i++) {
								...
								for (int j = 0; j < opcionesDTO.size(); j++) {
									...
									String opcionEstado = opDTO.getOpc_activo();

									if (usuActivo.equals("1")==true){
										usuarioEstandar.add("/seguridad_system/XHTML/initialMenu.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("1")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segUsuario.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("2")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segSucursal.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("3")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segSistema.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("4")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segRol.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("5")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segRolUsuario.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("6")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segGrupoOpcion.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("7")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/tree.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("8")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segAuditoria.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("9")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segCompania.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("10")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segParametro.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("11")==true) && (opcionEstado.trim().equals("1"))){
										usuarioEstandar.add("/seguridad_system/XHTML/segSistemaCia.xhtml");
									}
									if (usuActivo.equals("1")==true && (opcionCodigo.equals("12")==true) && (opcionEstado.trim().equals("1"))){
